    ...
    public function getAppConfig(): JsonResponse
    {
        try {
            ...
            $appConfig = [
                ...
                'app_slogan' => $generalSettings['app_slogan'] ?? '',
                'app_keywords' => $generalSettings['app_keywords'] ?? '',
                'app_logo' => $generalSettings['app_logo'] ?? $generalSettings['company_logo'] ?? '',
                'app_favicon' => $generalSettings['app_favicon'] ?? $generalSettings['favicon'] ?? '',
                'company_logo' => $generalSettings['company_logo'] ?? '',
                'favicon' => $generalSettings['favicon'] ?? '',
                'facebook_pxm_api_key' => $generalSettings['facebook_pxm_api_key'] ?? '',
