...
declare module 'vue-router/auto-routes' {
  ...
  export interface RouteNamedMap {
    ...
    'admin-produits-parent': RouteRecordInfo<'admin-produits-parent', '/admin/produits', Record<never, never>, Record<never, never>>,
    ...
    'admin-produits-edit': RouteRecordInfo<'admin-produits-edit', '/admin/produits/Edit', Record<never, never>, Record<never, never>>,
    'admin-produits-show': RouteRecordInfo<'admin-produits-show', '/admin/produits/Show', Record<never, never>, Record<never, never>>,
